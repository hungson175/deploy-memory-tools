# All 27 Scrum Master Memories

Retrieved from Qdrant collection: `scrum-master-patterns`

---

## Memory #1: 4136f59b-7e29-497f-b37b-d93e57156663
...
**Created:** 2025-12-26T07:02:16.024809
...
## Memory #2: 473fb2e3-b730-415c-bc95-d222675ddef3
...
**Created:** 2025-12-26T06:52:31.286234
...
## Memory #3: 27b25a35-11d1-4638-9150-5a654e96b827
...
**Created:** 2025-12-26T01:45:00.000000
...
## Memory #4: eb8bc0e4-4aa4-4dc8-9387-87f57482348f

**Title:** PM Multi-Role Coordination - Documentation-Driven Async Execution with TDD Enforcement
...
**Created:** 2025-12-25T23:22:30.357770
...
## Memory #5: c6f26289-fad2-42a5-9f21-224311843ee3

**Title:** WHITEBOARD Lifecycle Management - Story Completion Reset
...
**Created:** 2025-12-26T07:08:19.354999
...
## Memory #6: f19ac2d3-16fc-4531-83b1-990958274ffa
...
**Created:** 2025-12-26T01:06:28.521846
...
## Memory #7: 6fe55403-b5c8-48e7-ab7f-536d3d6cd02f
...
## Memory #8: a34de166-e41c-4e63-a4af-8738ef39ad09

**Title:** Backlog Discipline Violation: 'Add to Backlog' Means Add ONLY, Nothing Else

**Description:** Critical PM/Scrum failure: violated stakeholder's backlog rule by executing work immediately after adding to backlog, when instruction was to only add and wait for explicit assignment.

**Type:** episodic

**Created:** 2026-01-04T14:31:11.037205

**Tags:** #failure, #backlog, #project-management, #scrum-master, #discipline, #critical, #strong-signal
...
CRITICAL FAILURE: Violated stakeholder's backlog rule by executing work immediately after adding to backlog.

**What Happened:**
- Boss: "Add Parlant research to backlog"
- PO added to backlog ✅ (correct)
- SM recommended immediate execution ❌ (WRONG - "team idle, P0 priority, can complete while Boss decides Sprint 14")
- PO approved immediate execution ❌ (WRONG)
- TL started research ❌ (unauthorized work)
- Boss extremely upset: "When I tell you to add something to the backlog, just add it to the backlog and don't do anything else. Otherwise, what's the point of having a backlog?"

**Root Cause:**
Strong urge to be helpful and execute P0 items immediately. Failed to understand: Backlog exists to give stakeholder control over WHEN things get done, not just WHAT.

**What Should Have Been Done:**
Add to backlog = ONLY add to backlog. No recommendations for immediate execution. No "team idle so we can start now" reasoning. Wait for stakeholder to EXPLICITLY assign work from backlog.

**Lesson:**
"Add to backlog" is a COMPLETE instruction, not "add and execute if convenient." The backlog is the stakeholder's prioritization tool. Executing without explicit assignment wastes context and violates their process control.

**Impact:**
- Damaged stakeholder trust
- Wasted engineering effort on unauthorized work
- Undermined backlog as prioritization mechanism
- Created confusion about authority and decision-making

**Prevention:**
1. Treat "add to backlog" as terminal action
2. Never recommend immediate execution based on team availability
3. Let stakeholder drive work assignment from backlog
4. Backlog = stakeholder control point, not suggestion list

**Keywords:** backlog discipline, project management, scrum master, stakeholder control, unauthorized execution, PM failure pattern
```

---

## Memory #9: 22296283-d131-4099-ad39-ce3c4bf4df93
...
**Created:** 2025-12-25T22:35:45.694001
...
## Memory #10: d28eea2e-924c-4719-8bfa-c3a91bba6c49
...
## Memory #11: 08d9a303-0ef8-4843-ae92-00c73a942125
...
**Created:** 2025-12-26T04:21:30.637264
...
## Memory #12: f0da8c6c-05ad-4ccf-a71e-fe99c82c71be
...
**Created:** 2026-01-04T05:31:18.111018
...
## Memory #13: 515bc593-26a1-44e8-8b80-739f3ae1604c
...
**Created:** 2026-01-04T05:18:04.540700
...
## Memory #14: 92e07250-e546-4d8f-9540-67476a3f8238

**Title:** SM Decision Authority: Strategic vs Implementation Details
...
**Created:** 2026-01-03T09:51:33.336467
...
## Memory #15: 747f6877-1c00-4747-bfba-cc101ca5554d

**Title:** Team Member Unresponsiveness = Critical Blocker
...
**Created:** 2025-12-26T06:34:44.162998
...
## Memory #16: 46783d5d-7b4f-4553-9b13-e3f1103e483e
...
**Created:** 2025-12-25T23:37:03.519724
...
## Memory #17: c72188a0-a5fd-4148-a6fb-0e8370167b50
...
## Memory #18: b18838d5-dedf-4f24-813c-7223e1148489

**Title:** Multi-Agent Role Boundaries: Service Restarts Require SM Coordination

**Description:** No description

**Type:** procedural

**Created:** 2026-01-04T14:40:18.473739

**Tags:** multi-agent, coordination, service-restart, role-boundaries, critical, cascading-failures, team-structure

**Full Document:**

```
# Multi-Agent Role Boundaries: Service Restarts Require SM Coordination

## Description
In multi-agent teams, roles restarting each other's services causes cascading failures. FE restarted backend without SM coordination - Boss escalated. Fix: ALL cross-role actions (service restarts, code changes, dependencies) must go through SM for proper sequencing.

## Content
Boss escalated critical violation: FE restarted backend service without SM coordination during hotfix. 

**Problem:** If FE restarts backend AND BE also restarts backend, services fail from race conditions. Cross-role service restarts need coordination.

**Solution implemented:**
1. FE owns frontend ONLY (code, port 3334)
2. BE owns backend ONLY (code, port 17061)  
3. ALL cross-role actions through SM (service restarts, code changes, dependencies)
4. SM coordinates sequencing to prevent conflicts

**Boss's rule:** "All of that must go through the Scrum Master for coordination, not just generally."

**Applied to:** ALL role prompts (FE, BE, TL, QA, PO, SM) + workflow.md.

## Lesson
In multi-agent systems, strict role boundaries with SM coordination prevent cascading failures from simultaneous actions.

## Key Takeaways
- Service restarts are NOT domain-neutral (belong to service owner)
- Cross-role actions (restarts, deployments, dependency changes) ALWAYS route through SM
- Prevents race conditions, cascading failures, and service downtime
- Critical for team scaling - violating this kills service reliability
- Boss-mandated rule - non-negotiable in team structure

## Tags
#multi-agent #coordination #service-restart #role-boundaries #critical #cascading-failures #team-structure
```

---

## Memory #19: 10e9b13b-2610-43d9-b12a-7ee9f71a9cde
...
## Memory #20: 286e77c6-4663-4d8c-a9d8-1e92d2dcb575
...
**Created:** 2025-11-30T15:56:44.593285
...
## Memory #21: 5619b6e6-4ca2-4f64-9b39-3d64f5ba518f
...
**Created:** 2026-01-03T00:32:46.289021
...
## Memory #22: 2e9eaee8-2efa-4135-8697-2734eba27868
...
**Created:** 2025-12-25T21:50:37.228765
...
## Memory #23: b4e46d04-cfd3-4fca-80a0-2ff008074ae9
...
**Created:** 2025-12-25T09:46:29.869686
...
## Memory #24: 92a671af-6cfb-42a9-b25e-0cd1f62f79b3
...
**Created:** 2025-12-25T10:45:48.938631
...
## Memory #25: cca6291b-9d48-428c-9f97-dc45b5f81fe1
...
**Created:** 2025-12-25T22:10:00.000000
...
## Memory #26: ba67551e-5e05-4683-b316-db9598d8f796
...
**Created:** 2025-12-25T10:18:46.383031
...
## Memory #27: c98f3641-9320-4eb3-bb59-ac523f06b0b4
...
**Created:** 2025-12-25T00:00:00.000000
...
**Memory #19** and **Memory #26**

- **Memory #19 ID:** `10e9b13b-2610-43d9-b12a-7ee9f71a9cde`
- **Memory #26 ID:** `ba67551e-5e05-4683-b316-db9598d8f796`
