...
Claude Code keeps forgetting everything - repeats the same bugs daily. It's like an IOI student who forgets everything the next morning.
...
I wrote a memory system so Claude Code gets better and better as it works.

The system learns from past mistakes and successes, storing patterns that matter and forgetting what doesn't. Over time, Claude Code becomes more effective at your specific workflow.

---

# How It Works (Optional)

**Target audience:** Software engineers or managers (tech people in general) who have used Claude Code intensively for 2-3+ months and understand what this is about.
...
**Status:** DRAFT V9 - IOI student metaphor, clearer solution, target audience specified
